...
## This repo: `claude-code-fleet-notify`
...
- **Escalation channels** (in preferred order):
  1. [GitHub Issues on this repo](https://github.com/palios-taey/claude-code-fleet-notify/issues) — async, the canonical surface
